...
This is a study of regional conflict trends using data from UCDP from an earlier assignment. I have attached the Quarto PDF Document here, and the replication .qmd file can be found in my repository.
